...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    changes: [
      "Added brand green splash screen for iOS PWA startup",
      "Splash fades out smoothly once app loads for polished native feel",
      "Fixed iOS status bar showing white instead of brand green on launch"
    ]
  },
  {
    version: "7.9",
