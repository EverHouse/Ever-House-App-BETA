...
import { signInWithEmail, signInWithOAuth, signUpWithEmail, resetPassword } from '../../lib/supabase';
                  ...
                  <>
                    ...
                    <div className="relative">
                      ...
                      <div className="relative flex justify-center text-xs">
                        <span className="bg-white px-4 text-primary/40 font-medium">or continue with</span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <button
                        ...
                        disabled={loading}
                        className="flex justify-center items-center gap-2 rounded-xl border border-black/10 px-3 py-3 text-sm font-medium text-primary hover:bg-black/5 transition-all disabled:opacity-50"
                      >
                    ...
                    >
                      ...
                      Continue with Membership Email
                    </button>
                  </>
                )}
