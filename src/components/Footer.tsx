...
const SocialLink: React.FC<{href: string; icon: 'instagram' | 'linkedin' | 'tiktok'}> = ({ href, icon }) => {
  ...
  return (
    <a 
      ...
      target="_blank" 
      rel="noreferrer" 
      className="w-11 h-11 rounded-full border border-[#E7E7DC]/20 flex items-center justify-center hover:bg-[#E7E7DC] hover:text-[#293515] transition-colors cursor-pointer text-[#E7E7DC]"
      aria-label={icon}
    >
      <IconComponent />
    </a>
